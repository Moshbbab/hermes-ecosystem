...
Reads sources, gathers facts, writes findings
...
Drafts prose in the user's voice

`scratch` or `dir:` into their Obsidian vault

`reviewer`

Reads output, leaves findings, gates approval
...
Writes client-side code

`worktree`

`ops`

Runs scripts, manages services, handles deployments

`dir:` into ops scripts repo

`pm`

Writes specs, acceptance criteria
