...
**SuperGrok OAuth** (preferred)

Browser login at `accounts.x.ai`, refreshed automatically

`hermes auth add xai-oauth` — see [xAI Grok OAuth (SuperGrok Subscription)](/docs/guides/xai-grok-oauth)
...
-   [xAI Grok OAuth (SuperGrok Subscription)](/docs/guides/xai-grok-oauth) — the OAuth setup guide
