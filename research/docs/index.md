...
-   **[`/llms.txt`](/docs/assets/files/llms-6a70cff2c45d8955ef9bc8f51406f1f2.txt)** — curated index of every doc page with short descriptions. ~17 KB, safe to load into an LLM context.
-   **[`/llms-full.txt`](/docs/assets/files/llms-full-2c7cd7dd24b45eb04d42488ce47f43f8.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
