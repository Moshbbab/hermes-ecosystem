...
-   **[`/llms.txt`](/docs/assets/files/llms-f39e59c425c43b4ecd1482473ae70473.txt)** — curated index of every doc page with short descriptions. ~17 KB, safe to load into an LLM context.
-   **[`/llms-full.txt`](/docs/assets/files/llms-full-515cd4c5570b7f77967430c76ff430be.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
