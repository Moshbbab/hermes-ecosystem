...
For source checkouts, use the [PM developer workflow](/docs/reference/package-management#developer-workflow) and a separate development home so the runtime sees plugins and middleware from the working tree:
