...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 217,695 stars as of 2026-07-20 |
...
- **You want it to be yours.** MIT-licensed, 217,695 stars (as of 2026-07-20), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 217,695 GitHub stars (as of 2026-07-20) — source: `api.github.com/repos/NousResearch/hermes-agent`
