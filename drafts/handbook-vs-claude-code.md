...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 223,770 stars as of 2026-08-01 |
...
- **You want it to be yours.** MIT-licensed, 223,770 stars (as of 2026-08-01), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 223,770 GitHub stars (as of 2026-08-01) — source: `api.github.com/repos/NousResearch/hermes-agent`
