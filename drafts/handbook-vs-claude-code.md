...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 238,736 stars as of 2026-08-31 |
...
- **You want it to be yours.** MIT-licensed, 238,736 stars (as of 2026-08-31), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 246+ projects in the Atlas →](/)**
