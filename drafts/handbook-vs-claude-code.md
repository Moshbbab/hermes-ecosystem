...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 237,694 stars as of 2026-08-28 |
...
- **You want it to be yours.** MIT-licensed, 237,694 stars (as of 2026-08-28), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Last updated:** 2026-08-28 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 237,694 GitHub stars (as of 2026-08-28) — source: `api.github.com/repos/NousResearch/hermes-agent`
