...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 232,856 stars as of 2026-08-19 |
...
- **You want it to be yours.** MIT-licensed, 232,856 stars (as of 2026-08-19), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Last updated:** 2026-08-19 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 232,856 GitHub stars (as of 2026-08-19) — source: `api.github.com/repos/NousResearch/hermes-agent`
