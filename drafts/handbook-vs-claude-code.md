...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 228,900 stars as of 2026-08-11 |
...
- **You want it to be yours.** MIT-licensed, 228,900 stars (as of 2026-08-11), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 226+ projects in the Atlas →](/)**
