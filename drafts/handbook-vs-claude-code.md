...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 233,680 stars as of 2026-08-21 |
...
- **You want it to be yours.** MIT-licensed, 233,680 stars (as of 2026-08-21), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 233,680 GitHub stars (as of 2026-08-21) — source: `api.github.com/repos/NousResearch/hermes-agent`
