...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 222,506 stars as of 2026-07-30 |
...
- **You want it to be yours.** MIT-licensed, 222,506 stars (as of 2026-07-30), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 222,506 GitHub stars (as of 2026-07-30) — source: `api.github.com/repos/NousResearch/hermes-agent`
