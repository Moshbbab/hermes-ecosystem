...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 246,172 stars as of 2026-09-16 |
...
- **You want it to be yours.** MIT-licensed, 246,172 stars (as of 2026-09-16), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 250+ projects in the Atlas →](/)**
