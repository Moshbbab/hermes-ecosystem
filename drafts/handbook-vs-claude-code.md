...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 227,634 stars as of 2026-08-09 |
...
- **You want it to be yours.** MIT-licensed, 227,634 stars (as of 2026-08-09), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 223+ projects in the Atlas →](/)**
