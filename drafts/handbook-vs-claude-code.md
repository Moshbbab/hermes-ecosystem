...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 241,414 stars as of 2026-09-04 |
...
- **You want it to be yours.** MIT-licensed, 241,414 stars (as of 2026-09-04), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Last updated:** 2026-09-04 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 241,414 GitHub stars (as of 2026-09-04) — source: `api.github.com/repos/NousResearch/hermes-agent`
