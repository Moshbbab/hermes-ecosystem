...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 237,917 stars as of 2026-08-29 |
...
- **You want it to be yours.** MIT-licensed, 237,917 stars (as of 2026-08-29), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 237,917 GitHub stars (as of 2026-08-29) — source: `api.github.com/repos/NousResearch/hermes-agent`
