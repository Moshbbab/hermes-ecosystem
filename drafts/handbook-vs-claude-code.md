...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 225,587 stars as of 2026-08-05 |
...
- **You want it to be yours.** MIT-licensed, 225,587 stars (as of 2026-08-05), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 221+ projects in the Atlas →](/)**
