...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 221,345 stars as of 2026-07-27 |
...
- **You want it to be yours.** MIT-licensed, 221,345 stars (as of 2026-07-27), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 207+ projects in the Atlas →](/)**
...
**Last updated:** 2026-07-27 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 221,345 GitHub stars (as of 2026-07-27) — source: `api.github.com/repos/NousResearch/hermes-agent`
