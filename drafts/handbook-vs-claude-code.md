...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 236,424 stars as of 2026-08-26 |
...
- **You want it to be yours.** MIT-licensed, 236,424 stars (as of 2026-08-26), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 240+ projects in the Atlas →](/)**
