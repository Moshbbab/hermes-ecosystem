...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 221,901 stars as of 2026-07-29 |
...
- **You want it to be yours.** MIT-licensed, 221,901 stars (as of 2026-07-29), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 221,901 GitHub stars (as of 2026-07-29) — source: `api.github.com/repos/NousResearch/hermes-agent`
