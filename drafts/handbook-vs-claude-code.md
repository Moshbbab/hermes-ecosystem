...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 242,211 stars as of 2026-09-06 |
...
- **You want it to be yours.** MIT-licensed, 242,211 stars (as of 2026-09-06), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 242,211 GitHub stars (as of 2026-09-06) — source: `api.github.com/repos/NousResearch/hermes-agent`
