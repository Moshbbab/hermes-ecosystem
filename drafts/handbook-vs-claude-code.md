...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 232,750 stars as of 2026-08-19 |
...
- **You want it to be yours.** MIT-licensed, 232,750 stars (as of 2026-08-19), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 232,750 GitHub stars (as of 2026-08-19) — source: `api.github.com/repos/NousResearch/hermes-agent`
