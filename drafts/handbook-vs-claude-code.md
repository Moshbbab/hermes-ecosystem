...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 234,016 stars as of 2026-08-22 |
...
- **You want it to be yours.** MIT-licensed, 234,016 stars (as of 2026-08-22), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 234+ projects in the Atlas →](/)**
