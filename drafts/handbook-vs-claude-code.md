...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 242,887 stars as of 2026-09-07 |
...
- **You want it to be yours.** MIT-licensed, 242,887 stars (as of 2026-09-07), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 242,887 GitHub stars (as of 2026-09-07) — source: `api.github.com/repos/NousResearch/hermes-agent`
