...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 221,869 stars as of 2026-07-28 |
...
- **You want it to be yours.** MIT-licensed, 221,869 stars (as of 2026-07-28), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 221,869 GitHub stars (as of 2026-07-28) — source: `api.github.com/repos/NousResearch/hermes-agent`
