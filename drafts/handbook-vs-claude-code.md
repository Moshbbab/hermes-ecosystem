...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 241,191 stars as of 2026-09-04 |
...
- **You want it to be yours.** MIT-licensed, 241,191 stars (as of 2026-09-04), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 241,191 GitHub stars (as of 2026-09-04) — source: `api.github.com/repos/NousResearch/hermes-agent`
