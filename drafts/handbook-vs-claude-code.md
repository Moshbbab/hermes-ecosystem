...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 217,564 stars as of 2026-07-20 |
...
- **You want it to be yours.** MIT-licensed, 217,564 stars (as of 2026-07-20), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 204+ projects in the Atlas →](/)**
...
**Cited stats:**
- 217,564 GitHub stars (as of 2026-07-20) — source: `api.github.com/repos/NousResearch/hermes-agent`
