...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 237,310 stars as of 2026-08-27 |
...
- **You want it to be yours.** MIT-licensed, 237,310 stars (as of 2026-08-27), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 243+ projects in the Atlas →](/)**
...
**Cited stats:**
- 237,310 GitHub stars (as of 2026-08-27) — source: `api.github.com/repos/NousResearch/hermes-agent`
