...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 248,770 stars as of 2026-09-25 |
...
- **You want it to be yours.** MIT-licensed, 248,770 stars (as of 2026-09-25), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 248,770 GitHub stars (as of 2026-09-25) — source: `api.github.com/repos/NousResearch/hermes-agent`
