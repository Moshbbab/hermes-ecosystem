...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 228,662 stars as of 2026-08-11 |
...
- **You want it to be yours.** MIT-licensed, 228,662 stars (as of 2026-08-11), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 224+ projects in the Atlas →](/)**
