...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 224,502 stars as of 2026-08-03 |
...
- **You want it to be yours.** MIT-licensed, 224,502 stars (as of 2026-08-03), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 219+ projects in the Atlas →](/)**
...
**Cited stats:**
- 224,502 GitHub stars (as of 2026-08-03) — source: `api.github.com/repos/NousResearch/hermes-agent`
