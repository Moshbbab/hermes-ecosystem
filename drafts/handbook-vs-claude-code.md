...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 238,470 stars as of 2026-08-30 |
...
- **You want it to be yours.** MIT-licensed, 238,470 stars (as of 2026-08-30), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 245+ projects in the Atlas →](/)**
...
**Last updated:** 2026-08-30 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 238,470 GitHub stars (as of 2026-08-30) — source: `api.github.com/repos/NousResearch/hermes-agent`
