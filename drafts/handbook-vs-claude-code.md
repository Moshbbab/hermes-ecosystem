...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 242,884 stars as of 2026-09-07 |
...
- **You want it to be yours.** MIT-licensed, 242,884 stars (as of 2026-09-07), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 249+ projects in the Atlas →](/)**
...
**Last updated:** 2026-09-07 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 242,884 GitHub stars (as of 2026-09-07) — source: `api.github.com/repos/NousResearch/hermes-agent`
