...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 220,135 stars as of 2026-07-25 |
...
- **You want it to be yours.** MIT-licensed, 220,135 stars (as of 2026-07-25), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 220,135 GitHub stars (as of 2026-07-25) — source: `api.github.com/repos/NousResearch/hermes-agent`
