...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 239,398 stars as of 2026-09-01 |
...
- **You want it to be yours.** MIT-licensed, 239,398 stars (as of 2026-09-01), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Last updated:** 2026-09-01 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 239,398 GitHub stars (as of 2026-09-01) — source: `api.github.com/repos/NousResearch/hermes-agent`
