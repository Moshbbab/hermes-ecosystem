...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 220,134 stars as of 2026-07-25 |
...
- **You want it to be yours.** MIT-licensed, 220,134 stars (as of 2026-07-25), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Last updated:** 2026-07-25 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 220,134 GitHub stars (as of 2026-07-25) — source: `api.github.com/repos/NousResearch/hermes-agent`
