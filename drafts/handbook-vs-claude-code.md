...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 247,023 stars as of 2026-09-19 |
...
- **You want it to be yours.** MIT-licensed, 247,023 stars (as of 2026-09-19), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 251+ projects in the Atlas →](/)**
