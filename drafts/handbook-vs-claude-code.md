...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 237,696 stars as of 2026-08-28 |
...
- **You want it to be yours.** MIT-licensed, 237,696 stars (as of 2026-08-28), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 237,696 GitHub stars (as of 2026-08-28) — source: `api.github.com/repos/NousResearch/hermes-agent`
