...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 232,479 stars as of 2026-08-18 |
...
- **You want it to be yours.** MIT-licensed, 232,479 stars (as of 2026-08-18), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 232,479 GitHub stars (as of 2026-08-18) — source: `api.github.com/repos/NousResearch/hermes-agent`
