...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 216,568 stars as of 2026-07-18 |
...
- **You want it to be yours.** MIT-licensed, 216,568 stars (as of 2026-07-18), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 216,568 GitHub stars (as of 2026-07-18) — source: `api.github.com/repos/NousResearch/hermes-agent`
