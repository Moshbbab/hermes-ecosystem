...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 217,069 stars as of 2026-07-19 |
...
- **You want it to be yours.** MIT-licensed, 217,069 stars (as of 2026-07-19), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 217,069 GitHub stars (as of 2026-07-19) — source: `api.github.com/repos/NousResearch/hermes-agent`
