...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 226,974 stars as of 2026-08-07 |
...
- **You want it to be yours.** MIT-licensed, 226,974 stars (as of 2026-08-07), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 222+ projects in the Atlas →](/)**
