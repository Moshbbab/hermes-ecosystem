...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 220,596 stars as of 2026-07-26 |
...
- **You want it to be yours.** MIT-licensed, 220,596 stars (as of 2026-07-26), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 220,596 GitHub stars (as of 2026-07-26) — source: `api.github.com/repos/NousResearch/hermes-agent`
