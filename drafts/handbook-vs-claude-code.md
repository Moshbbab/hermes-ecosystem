...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 231,424 stars as of 2026-08-16 |
...
- **You want it to be yours.** MIT-licensed, 231,424 stars (as of 2026-08-16), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 231,424 GitHub stars (as of 2026-08-16) — source: `api.github.com/repos/NousResearch/hermes-agent`
