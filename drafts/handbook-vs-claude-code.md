...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 236,337 stars as of 2026-08-25 |
...
- **You want it to be yours.** MIT-licensed, 236,337 stars (as of 2026-08-25), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 239+ projects in the Atlas →](/)**
