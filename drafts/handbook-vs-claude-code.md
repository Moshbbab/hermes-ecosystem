...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 218,891 stars as of 2026-07-22 |
...
- **You want it to be yours.** MIT-licensed, 218,891 stars (as of 2026-07-22), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 218,891 GitHub stars (as of 2026-07-22) — source: `api.github.com/repos/NousResearch/hermes-agent`
