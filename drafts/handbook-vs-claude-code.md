...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 231,836 stars as of 2026-08-17 |
...
- **You want it to be yours.** MIT-licensed, 231,836 stars (as of 2026-08-17), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 231,836 GitHub stars (as of 2026-08-17) — source: `api.github.com/repos/NousResearch/hermes-agent`
