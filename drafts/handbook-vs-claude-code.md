...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 218,974 stars as of 2026-07-23 |
...
- **You want it to be yours.** MIT-licensed, 218,974 stars (as of 2026-07-23), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 205+ projects in the Atlas →](/)**
...
**Last updated:** 2026-07-23 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 218,974 GitHub stars (as of 2026-07-23) — source: `api.github.com/repos/NousResearch/hermes-agent`
