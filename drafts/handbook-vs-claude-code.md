...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 248,575 stars as of 2026-09-24 |
...
- **You want it to be yours.** MIT-licensed, 248,575 stars (as of 2026-09-24), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 248,575 GitHub stars (as of 2026-09-24) — source: `api.github.com/repos/NousResearch/hermes-agent`
