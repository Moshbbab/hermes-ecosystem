...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 219,927 stars as of 2026-07-24 |
...
- **You want it to be yours.** MIT-licensed, 219,927 stars (as of 2026-07-24), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 219,927 GitHub stars (as of 2026-07-24) — source: `api.github.com/repos/NousResearch/hermes-agent`
