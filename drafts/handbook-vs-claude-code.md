...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 224,508 stars as of 2026-08-03 |
...
- **You want it to be yours.** MIT-licensed, 224,508 stars (as of 2026-08-03), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 224,508 GitHub stars (as of 2026-08-03) — source: `api.github.com/repos/NousResearch/hermes-agent`
