...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 233,856 stars as of 2026-08-21 |
...
- **You want it to be yours.** MIT-licensed, 233,856 stars (as of 2026-08-21), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 232+ projects in the Atlas →](/)**
