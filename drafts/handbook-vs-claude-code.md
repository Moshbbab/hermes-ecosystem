...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 216,781 stars as of 2026-07-18 |
...
- **You want it to be yours.** MIT-licensed, 216,781 stars (as of 2026-07-18), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 203+ projects in the Atlas →](/)**
...
**Last updated:** 2026-07-18 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 216,781 GitHub stars (as of 2026-07-18) — source: `api.github.com/repos/NousResearch/hermes-agent`
