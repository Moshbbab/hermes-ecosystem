...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 219,663 stars as of 2026-07-24 |
...
- **You want it to be yours.** MIT-licensed, 219,663 stars (as of 2026-07-24), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Last updated:** 2026-07-24 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 219,663 GitHub stars (as of 2026-07-24) — source: `api.github.com/repos/NousResearch/hermes-agent`
