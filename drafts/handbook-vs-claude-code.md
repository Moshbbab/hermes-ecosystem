...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 240,244 stars as of 2026-09-03 |
...
- **You want it to be yours.** MIT-licensed, 240,244 stars (as of 2026-09-03), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 240,244 GitHub stars (as of 2026-09-03) — source: `api.github.com/repos/NousResearch/hermes-agent`
