...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 224,802 stars as of 2026-08-03 |
...
- **You want it to be yours.** MIT-licensed, 224,802 stars (as of 2026-08-03), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 220+ projects in the Atlas →](/)**
