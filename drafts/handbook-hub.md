...
<<<<<<< HEAD
**Hermes Agent is an open-source AI agent by [Nous Research](https://nousresearch.com) that runs on your own machine or a cheap VPS, remembers what it learns across sessions, and writes its own reusable skills as it works. It talks to you through a CLI, Telegram, Discord, email, and many other messaging providers. It hit 243,920 GitHub stars (as of 2026-09-10), and it's the fastest-growing open-source agent of 2026.**
=======
**Hermes Agent is an open-source AI agent by [Nous Research](https://nousresearch.com) that runs on your own machine or a cheap VPS, remembers what it learns across sessions, and writes its own reusable skills as it works. It talks to you through a CLI, Telegram, Discord, email, and many other messaging providers. It hit 243,920 GitHub stars (as of 2026-09-10), and it's the fastest-growing open-source agent of 2026.**
>>>>>>> origin/main
...
**Last updated:** 2026-09-10 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
<<<<<<< HEAD
- 243,920 GitHub stars (as of 2026-09-10) — source: `api.github.com/repos/NousResearch/hermes-agent`
- 249+ projects in the Hermes Atlas (as of 2026-09-10)
=======
- 243,920 GitHub stars (as of 2026-09-10) — source: `api.github.com/repos/NousResearch/hermes-agent`
- 249+ projects in the Hermes Atlas (as of 2026-09-10)
>>>>>>> origin/main
