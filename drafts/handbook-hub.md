...
The handbook teaches you the fundamentals. The Atlas is where you find the specific tool you need for a specific job, ranked, filtered, and security-reviewed. **[Browse all 236+ projects →](/)**.
...
**Cited stats:**
- 234,141 GitHub stars (as of 2026-08-22) — source: `api.github.com/repos/NousResearch/hermes-agent`
- 236+ projects in the Hermes Atlas (as of 2026-08-22)
