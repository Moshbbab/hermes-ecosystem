...
The handbook teaches you the fundamentals. The Atlas is where you find the specific tool you need for a specific job, ranked, filtered, and security-reviewed. **[Browse all 234+ projects →](/)**.
...
**Last updated:** 2026-08-22 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 234,016 GitHub stars (as of 2026-08-22) — source: `api.github.com/repos/NousResearch/hermes-agent`
- 234+ projects in the Hermes Atlas (as of 2026-08-22)
