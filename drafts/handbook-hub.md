...
**Hermes Agent is an open-source AI agent by [Nous Research](https://nousresearch.com) that runs on your own machine or a cheap VPS, remembers what it learns across sessions, and writes its own reusable skills as it works. It talks to you through a CLI, Telegram, Discord, email, and many other messaging providers. It hit 225,076 GitHub stars (as of 2026-08-04), and it's the fastest-growing open-source agent of 2026.**
...
**Cited stats:**
- 225,076 GitHub stars (as of 2026-08-04) — source: `api.github.com/repos/NousResearch/hermes-agent`
