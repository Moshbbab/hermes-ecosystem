...
<<<<<<< HEAD
**Hermes Agent is an open-source AI agent by [Nous Research](https://nousresearch.com) that runs on your own machine or a cheap VPS, remembers what it learns across sessions, and writes its own reusable skills as it works. It talks to you through a CLI, Telegram, Discord, email, and many other messaging providers. It hit 245,024 GitHub stars (as of 2026-09-13), and it's the fastest-growing open-source agent of 2026.**
=======
**Hermes Agent is an open-source AI agent by [Nous Research](https://nousresearch.com) that runs on your own machine or a cheap VPS, remembers what it learns across sessions, and writes its own reusable skills as it works. It talks to you through a CLI, Telegram, Discord, email, and many other messaging providers. It hit 245,024 GitHub stars (as of 2026-09-13), and it's the fastest-growing open-source agent of 2026.**
>>>>>>> origin/main
...
Hermes self-updates. It tells you what changed, backs up your config, and applies the new version. Current release is v0.21.2 (as of 2026-09-11); the team ships roughly every two weeks.
...
**Last updated:** 2026-09-13 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
<<<<<<< HEAD
- 245,024 GitHub stars (as of 2026-09-13) — source: `api.github.com/repos/NousResearch/hermes-agent`
- 250+ projects in the Hermes Atlas (as of 2026-09-13)
=======
- 245,024 GitHub stars (as of 2026-09-13) — source: `api.github.com/repos/NousResearch/hermes-agent`
- 250+ projects in the Hermes Atlas (as of 2026-09-13)
>>>>>>> origin/main
